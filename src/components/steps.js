...
Steps.defaultProps = {
  step2Description:
    'Work closely with our team to bring your vision to life and achieve your goals.',
  step1Title: 'Discover',
  step4Title: 'Celebrate',
  step1Description:
    'Explore our services and discover how we can help elevate your brand.',
  step2Title: 'Collaborate',
  step3Title: 'Create',
  step3Description:
    'Together, we will create innovative solutions tailored to meet your specific needs.',
  step4Description:
    'Celebrate the success of our collaboration and the growth of your brand.',
}
