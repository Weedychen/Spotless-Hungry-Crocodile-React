...
Contact.defaultProps = {
  ...
  content5:
    'Join us in our mission to create impactful and innovative solutions for businesses worldwide.',
  content4:
    'Connect with us on social media for the latest updates, news, and projects.',
  email1: 'info@example.com',
  phone1: '+1 (123) 456-7890',
  content3:
    'Our team is dedicated to providing top-notch service and support to all our clients.',
  content2:
    'For business inquiries or collaboration opportunities, feel free to reach out using the contact form below.',
